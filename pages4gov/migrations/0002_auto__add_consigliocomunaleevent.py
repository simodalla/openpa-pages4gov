...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting model 'ConsiglioComunaleEvent'
        db.delete_table('pages4gov_consigliocomunaleevent')
    ...
    models = {
        ...
        'pages4gov.consigliocomunaleevent': {
            ...
            'data_of_performance': ('django.db.models.fields.DateTimeField', [], {}),
            ...
            'youtube_video_url_query': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '200'})
        },
        'sites.site': {
